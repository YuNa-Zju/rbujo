|**Modal 文件名**|**归属总线**|**说明**|
|---|---|---|
|`AddEntryModal.tsx`|**Entry Bus**|(已在 GlobalEntryModals) 新建/编辑|
...
|**`SearchModal.tsx`**|**✅ UI Bus**|全局搜索|
|**`TagSearchModal.tsx`**|**✅ UI Bus**|标签搜索|
|**`FutureLogModal.tsx`**|**✅ UI Bus**|未来日志视图|
|**`TimelineModal.tsx`**|**✅ UI Bus**|时间轴视图|
|**`CalendarSyncModal.tsx`**|**✅ UI Bus**|日历同步设置|
|**`ChangePasswordModal.tsx`**|**✅ UI Bus**|修改密码|
|**`LogoutModal.tsx`**|**✅ UI Bus**|登出确认|